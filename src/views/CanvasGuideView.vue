  ...
  >
    <aside>
      <div class="sticky top-6">
        <div class="surface-panel canvas-guide-panel rounded-[7px] p-4 lg:p-5">
          <div class="mb-4 px-2">
    ...
    <article class="surface-panel canvas-guide-panel rounded-[7px] p-6 lg:p-8">
    ...
    <aside class="surface-panel canvas-guide-panel rounded-[7px] p-4 lg:p-5">
      <div class="sticky top-6">
        <div class="mb-4 px-2">
          <p class="text-xs tracking-[0.28em] text-slate-400 uppercase">
            当前目录
